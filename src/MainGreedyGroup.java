...
public class MainGreedyGroup {
    public static void main(String[] args) {
        System.out.println("GREEDY GROUP STRATEGY TEST");
        GreedyGroupStrategy greedyGroupStrategy = new GreedyGroupStrategy();
        Controller<Map<String, Integer>, Integer> controller = new Controller<>(5,30, greedyGroupStrategy);
        ...
        for(String action : actions) {
            ...
            Invoker selectedInvoker = greedyGroupStrategy.assignFunction(invokers, functions);
